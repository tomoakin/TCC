...
Sun et al., submitted \cite{sun}) provides users with a robust and accurate 
...
follows: \Rpackage{TCC} (Sun et al., submitted \cite{sun}), 
TMM (Robinson and Oshlack, 2010 \cite{robinson2}), 
...
citations are as follows: \Rpackage{TCC} (Sun et al., submitted \cite{sun}) 
